...
**Expected behaviour:** The pricing question is answered from the SOP and is not treated as pricing negotiation. Questions are asked one at a time. Short qualification answers are not escalated, all three fields are collected, and no qualification fields are recorded as SOP gaps.
